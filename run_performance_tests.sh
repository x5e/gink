...
python python/gink/performance_tests/gink_performance.py -o data.json -c 1000 -i 5 &&
python python/gink/performance_tests/sqlite_performance.py -o data.json -c 1000 -i 5 &&
...
python python/gink/performance_tests/comparison_graph.py -d data.json
