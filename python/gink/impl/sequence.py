...
from .coding import QUEUE, decode_value
...
class Sequence(Container):
    ...
    def items(self, as_of: GenericTimestamp = None) -> Iterable:
        ...
        for hit in self._database._store.get_ordered_entries(self._muid, as_of=as_of):
            #yield (hit.entry_muid, decode_value(hit.)
            raise NotImplementedError()
        raise NotImplementedError()

    def to_list(self, as_of: GenericTimestamp = None):
    ...
    def at(self, what, as_of: GenericTimestamp = None):
