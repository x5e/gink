...
def test_repr_some():
    ...
    abc = BundleInfo(timestamp=125, medallion=3, chain_start=123, prior_time=123, comment='x')
    xyz = "BundleInfo(timestamp=125, medallion=3, chain_start=123, prior_time=123, comment='x')"
...
def test_order():
    ...
    info3 = BundleInfo(timestamp=125, medallion=789, chain_start=123, prior_time=123)
