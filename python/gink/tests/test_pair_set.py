...
def test_creation():
    ...
    for store in [LmdbStore(), MemoryStore()]:
        with closing(store):
            ...
            vertex2 = Vertex()
            vertex3 = Vertex()
            pairset3 = PairSet(contents={"included": [(vertex1, vertex2), (vertex2, vertex3), (vertex1, vertex3)]})
...
def test_dumps():
    ...
    for store in [LmdbStore(), MemoryStore()]:
        with closing(store):
            ...
            vertex2 = Vertex(database=database)
            vertex3 = Vertex(database=database)
            pairset1 = PairSet(contents={"included": [(vertex1, vertex2), (vertex1, vertex3), (vertex2, vertex3)]}, database=database)
