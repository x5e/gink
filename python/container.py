...
class Container(ABC):
    ...
    def _add_entry(self, key: U[str, int, None], value,
        ...
        elif isinstance(value, (str, int, float, dict, tuple, bool, type(None))):
            encode_value(value, entry_builder.immediate) # type: ignore # pylint: disable=maybe-no-member
