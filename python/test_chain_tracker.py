...
def test_tracking():
    ...
    info1 = ChangeSetInfo(medallion=123, chain_start=345, timestamp=789)
    info2 = ChangeSetInfo(medallion=222, chain_start=345, timestamp=789)
    info3 = ChangeSetInfo(medallion=123, chain_start=345, timestamp=346)
    info4 = ChangeSetInfo(medallion=222, chain_start=888, timestamp=900)
...
def test_to_greeting_message():
    ...
    chain_tracker = ChainTracker()
    info1 = ChangeSetInfo(medallion=123, chain_start=345, timestamp=789)
    info2 = ChangeSetInfo(medallion=222, chain_start=888, timestamp=900)
    info3 = ChangeSetInfo(medallion=123, chain_start=888, timestamp=899)
    chain_tracker.mark_as_having(info1)
